var rough = (function () {
  ...
  function s(e, t, s, n) {
    let r = t[1] - e[1],
      ...
      h = a * s[0] + o * s[1],
      u = r * o - a * l;
    return u ? [(o * i - l * h) / u, (r * h - a * i) / u] : null;
  }
  function n(e, t, s) {
    let n = e.length;
    if (n < 3) return !1;
    ...
    let o = (function (e, t) {
        ...
        if (s && s.length > 2) {
          ...
          for (; u.length || l.length; ) {
            if (l.length) {
              let $ = -1;
              for (let p = 0; p < l.length && !(l[p].ymin > c); p++) $ = p;
              l.splice(0, $ + 1).forEach((e) => {
                u.push({ s: c, edge: e });
              });
            }
            if (
    ...
    connectingLines(e, s) {
      ...
      if (s.length > 1)
        for (let r = 1; r < s.length; r++) {
          ...
          let i = [s[r][0], l[1]];
          if (t(i) > 3) {
            let a = this.splitOnIntersections(e, i);
            n.push(...a);
          }
        }
      return n;
  ...
  class c {
    ...
    dotsOnLines(e, s) {
      ...
      for (let a of e) {
        ...
        for (let p = 0; p < h; p++) {
          let _ = $ + u + p * r,
            f = this.helper.randOffsetWithRange(c - i, c + i, s),
            d = this.helper.randOffsetWithRange(_ - i, _ + i, s),
            g = this.helper.ellipse(f, d, l, l, s);
          n.push(...g.ops);
        }
      }
      ...
      return (
        e.forEach((e) => {
          ...
          for (let $ = 0; $ < a; $++) {
            ...
            l.push(...this.helper.doubleLineOps(f[0], f[1], d[0], d[1], s));
          }
        }),
        l
      );
  ...
  class p {
    ...
    zigzagLines(e, s, n) {
      ...
      return (
        e.forEach((e) => {
          let l = Math.round(t(e) / (2 * s)),
            i = e[0],
            a = e[1];
          i[0] > a[0] && ((i = e[1]), (a = e[0]));
          let o = Math.atan((a[1] - i[1]) / (a[0] - i[0]));
          for (let h = 0; h < l; h++) {
            let u = 2 * h * s,
              c = 2 * (h + 1) * s,
              $ = Math.sqrt(2 * Math.pow(s, 2)),
              p = [i[0] + u * Math.cos(o), i[1] + u * Math.sin(o)],
              _ = [i[0] + c * Math.cos(o), i[1] + c * Math.sin(o)],
              f = [
  ...
  function k(e) {
    ...
    for (; !g(l, 2); ) {
      let i = 0,
        a = [];
      if ("BOD" === n) {
        if ("M" !== l.text && "m" !== l.text) return k("M0,0" + e);
        r++, (i = d[l.text]), (n = l.text);
      } else g(l, 1) ? (i = d[n]) : (r++, (i = d[l.text]), (n = l.text));
      if (!(r + i < s.length)) throw Error("Path data ended short");
      for (let o = r; o < r + i; o++) {
        let h = s[o];
  ...
  function y(e) {
    let t = 0,
      ...
      r = 0,
      l = [];
    for (let { key: i, data: a } of e)
      switch (i) {
        case "M":
          l.push({ key: "M", data: [...a] }), ([t, s] = a), ([n, r] = a);
          break;
        case "m":
          (t += a[0]),
            (s += a[1]),
            l.push({ key: "M", data: [t, s] }),
            (n = t),
            (r = s);
          break;
        case "L":
          l.push({ key: "L", data: [...a] }), ([t, s] = a);
          break;
        case "l":
          (t += a[0]), (s += a[1]), l.push({ key: "L", data: [t, s] });
          break;
        case "C":
          l.push({ key: "C", data: [...a] }), (t = a[4]), (s = a[5]);
          break;
        case "c": {
          let o = a.map((e, n) => (n % 2 ? e + s : e + t));
          l.push({ key: "C", data: o }), (t = o[4]), (s = o[5]);
          break;
        }
        case "Q":
          l.push({ key: "Q", data: [...a] }), (t = a[2]), (s = a[3]);
          break;
        case "q": {
          let h = a.map((e, n) => (n % 2 ? e + s : e + t));
          l.push({ key: "Q", data: h }), (t = h[2]), (s = h[3]);
          break;
        }
        case "A":
          l.push({ key: "A", data: [...a] }), (t = a[5]), (s = a[6]);
          break;
        case "a":
          (t += a[5]),
            (s += a[6]),
            l.push({ key: "A", data: [a[0], a[1], a[2], a[3], a[4], t, s] });
          break;
        case "H":
          l.push({ key: "H", data: [...a] }), (t = a[0]);
          break;
        case "h":
          (t += a[0]), l.push({ key: "H", data: [t] });
          break;
        case "V":
          l.push({ key: "V", data: [...a] }), (s = a[0]);
          break;
        case "v":
          (s += a[0]), l.push({ key: "V", data: [s] });
          break;
        case "S":
          l.push({ key: "S", data: [...a] }), (t = a[2]), (s = a[3]);
          break;
        case "s": {
          let u = a.map((e, n) => (n % 2 ? e + s : e + t));
          l.push({ key: "S", data: u }), (t = u[2]), (s = u[3]);
          break;
        }
        case "T":
          l.push({ key: "T", data: [...a] }), (t = a[0]), (s = a[1]);
          break;
        case "t":
          (t += a[0]), (s += a[1]), l.push({ key: "T", data: [t, s] });
          break;
        case "Z":
        case "z":
          l.push({ key: "Z", data: [] }), (t = n), (s = r);
      }
    return l;
  }
  function m(e) {
    ...
    for (let { key: h, data: u } of e) {
      switch (h) {
        case "M":
          t.push({ key: "M", data: [...u] }), ([n, r] = u), ([l, i] = u);
          break;
        case "C":
          t.push({ key: "C", data: [...u] }),
            (n = u[4]),
  ...
  function w(e, t, s, n, r, l, i, a, o, h) {
    var u;
    let c = (Math.PI * (u = i)) / 180,
      $ = [],
      p = 0,
      _ = 0,
      f = 0,
    ...
    if (h) [p, _, f, d] = h;
      ...
      let g = (e - s) / 2,
        k = (t - n) / 2,
        y = (g * g) / (r * r) + (k * k) / (l * l);
      y > 1 && ((r *= y = Math.sqrt(y)), (l *= y));
      let m = r * r,
        v = l * l,
        L =
          (a === o ? -1 : 1) *
          Math.sqrt(
            Math.abs((m * v - m * k * k - v * g * g) / (m * k * k + v * g * g))
          );
      (f = (L * r * k) / l + (e + s) / 2),
        (d = (-(L * l) * g) / r + (t + n) / 2),
        (p = Math.asin(parseFloat(((t - d) / l).toFixed(9)))),
        (_ = Math.asin(parseFloat(((n - d) / l).toFixed(9)))),
        e < f && (p = Math.PI - p),
        s < f && (_ = Math.PI - _),
        p < 0 && (p = 2 * Math.PI + p),
        _ < 0 && (_ = 2 * Math.PI + _),
      ...
      return [z, G, B].concat($);
    {
      ...
      for (let q = 0; q < $.length; q += 3) {
        let H = b($[q][0], $[q][1], c),
          N = b($[q + 1][0], $[q + 1][1], c),
          F = b($[q + 2][0], $[q + 2][1], c);
        R.push([H[0], H[1], N[0], N[1], F[0], F[1]]);
      }
      return R;
    }
  }
  ...
  function P(e, t, s) {
    ...
    if (n > 2) {
      let r = [];
      for (let l = 0; l < n - 1; l++)
        r.push(...D(e[l][0], e[l][1], e[l + 1][0], e[l + 1][1], s));
      return (
  ...
  function x(e, t, s) {
    ...
    return (
      (r += A(r * i, s)),
      (l += A(l * i, s)),
      { increment: (2 * Math.PI) / n, rx: r, ry: l }
    );
  }
  function C(e, t, s, n) {
    let [r, l] = G(
    ...
    if (!s.disableMultiStroke) {
      let [a] = G(n.increment, e, t, n.rx, n.ry, 1.5, 0, s),
        o = z(a, null, s);
      i = i.concat(o);
    }
    return { estimatedPoints: l, opset: { type: "path", ops: i } };
  }
  function S(e, t, s, n, r, l, i, a, o) {
    let h = e,
      u = t,
      c = Math.abs(s / 2),
      $ = Math.abs(n / 2);
  ...
  function D(e, t, s, n, r, l = !1) {
    let i = l ? r.disableMultiStrokeFill : r.disableMultiStroke,
      a = E(e, t, s, n, r, !0, !1);
    if (i) return a;
    let o = E(e, t, s, n, r, !0, !0);
    return a.concat(o);
  }
  function E(e, t, s, n, r, l, i) {
  ...
  function z(e, t, s) {
    ...
    if (n > 3) {
      ...
      for (let a = 1; a + 2 < n; a++) {
        ...
        (l[0] = [o[0], o[1]]),
          (l[1] = [
            o[0] + (i * e[a + 1][0] - i * e[a - 1][0]) / 6,
            o[1] + (i * e[a + 1][1] - i * e[a - 1][1]) / 6,
          ]),
          (l[2] = [
            e[a + 1][0] + (i * e[a][0] - i * e[a + 2][0]) / 6,
            e[a + 1][1] + (i * e[a][1] - i * e[a + 2][1]) / 6,
          ]),
          (l[3] = [e[a + 1][0], e[a + 1][1]]),
          r.push({
            op: "bcurveTo",
  ...
  function G(e, t, s, n, r, l, i, a) {
    let o = [],
      h = [],
      u = A(0.5, a) - Math.PI / 2;
    h.push([
      A(l, a) + t + 0.9 * n * Math.cos(u - e),
      A(l, a) + s + 0.9 * r * Math.sin(u - e),
    ]);
    for (let c = u; c < 2 * Math.PI + u - 0.01; c += e) {
      let $ = [A(l, a) + t + n * Math.cos(c), A(l, a) + s + r * Math.sin(c)];
      o.push($), h.push($);
    }
    return (
      h.push([
        A(l, a) + t + n * Math.cos(u + 2 * Math.PI + 0.5 * i),
        A(l, a) + s + r * Math.sin(u + 2 * Math.PI + 0.5 * i),
      ]),
      h.push([
        A(l, a) + t + 0.98 * n * Math.cos(u + i),
        A(l, a) + s + 0.98 * r * Math.sin(u + i),
      ]),
      h.push([
        A(l, a) + t + 0.9 * n * Math.cos(u + 0.5 * i),
        A(l, a) + s + 0.9 * r * Math.sin(u + 0.5 * i),
      ]),
      [h, o]
    );
  }
  function B(e, t, s, n, r, l, i, a, o) {
    let h = l + A(0.1, o),
      u = [];
    u.push([
    ...
    return (
      u.push([t + n * Math.cos(i), s + r * Math.sin(i)]),
      u.push([t + n * Math.cos(i), s + r * Math.sin(i)]),
      z(u, null, o)
    );
  }
  function R(e, t, s, n, r, l, i, a) {
    let o = [],
    ...
    for (let $ = 0; $ < c; $++)
      0 === $
        ...
        : o.push({ op: "move", data: [i[0] + A(h[0], a), i[1] + A(h[0], a)] }),
        (u = [r + A(h[$], a), l + A(h[$], a)]),
        o.push({
          op: "bcurveTo",
          data: [
  ...
  function Z(e, t, s, n) {
    ...
    if (
      ...
      let g = e[t + 0];
      o.length
        ? Math.sqrt(H((r = o[o.length - 1]), (l = g))) > 1 && o.push(g)
        : o.push(g),
        o.push(e[t + 3]);
    } else {
      let k = e[t + 0],
        ...
        x = F(v, L, 0.5),
        C = F(P, x, 0.5);
      Z([k, w, P, C], 0, s, o), Z([C, x, L, b], 0, s, o);
    }
    return o;
  }
  function Q(e, t) {
  ...
  function j(e, t, s, n, r) {
    ...
    return (
      Math.sqrt(o) > n
        ? (j(e, t, h + 1, n, l), j(e, h, s, n, l))
        : (l.length || l.push(i), l.push(a)),
      l
    );
  }
  ...
  class Y {
    ...
    line(e, t, s, n, r) {
      let l = this._o(r);
      return this._d("line", [L(e, t, s, n, l)], l);
    }
    rectangle(e, t, s, n, r) {
      var l, i, a, o, h, u, c;
      let $ = this._o(r),
    ...
    ellipse(e, t, s, n, r) {
      ...
      if (l.fill) {
        if ("solid" === l.fillStyle) {
          let h = C(e, t, l, a).opset;
          (h.type = "fillPath"), i.push(h);
        } else i.push(I(o.estimatedPoints, l));
      }
      return l.stroke !== X && i.push(o.opset), this._d("ellipse", i, l);
    }
    circle(e, t, s, n) {
    ...
    arc(e, t, s, n, r, l, i = !1, a) {
      let o = this._o(a),
        h = [],
        u = S(e, t, s, n, r, l, i, !0, o);
      if (i && o.fill) {
        if ("solid" === o.fillStyle) {
          let c = S(e, t, s, n, r, l, !0, !1, o);
          (c.type = "fillPath"), h.push(c);
        } else
          h.push(
            (function (e, t, s, n, r, l, i) {
              let a = e,
                o = t,
                h = Math.abs(s / 2),
                u = Math.abs(n / 2);
              (h += A(0.01 * h, i)), (u += A(0.01 * u, i));
              let c = r,
                $ = l;
              for (; c < 0; ) (c += 2 * Math.PI), ($ += 2 * Math.PI);
              $ - c > 2 * Math.PI && ((c = 0), ($ = 2 * Math.PI));
              let p = ($ - c) / i.curveStepCount,
                _ = [];
              for (let f = c; f <= $; f += p)
    ...
    curve(e, t) {
          ...
          if (!s.disableMultiStroke) {
            ...
            let l,
              i = M(
                ...
                (((l = Object.assign({}, (r = s))).randomizer = void 0),
                r.seed && (l.seed = r.seed + 1),
                l)
              );
            n = n.concat(i);
          }
      ...
      if (s.fill && s.fill !== X && e.length >= 3) {
          ...
          (function (e, t = 0) {
            ...
            if (3 === s) n.push(q(e[0]), q(e[1]), q(e[2]), q(e[2]));
              ...
              for (let l = 1; l < e.length; l++)
                r.push(e[l]), l === e.length - 1 && r.push(e[l]);
              let i = [],
                a = 1 - t;
              n.push(q(r[0]));
        ...
        "solid" === s.fillStyle ? n.push(O(l, s)) : n.push(I(l, s));
      }
      ...
      let r = s.fill && "transparent" !== s.fill && s.fill !== X,
        ...
        a = (function (e, t, s) {
          let n = m(y(k(e))),
            ...
            a = [],
            o = () => {
              a.length >= 4 && l.push(...V(a, 1)), (a = []);
            },
            h = () => {
              o(), l.length && (r.push(l), (l = []));
            };
          for (let { key: u, data: c } of n)
            switch (u) {
              case "M":
                h(), (i = [c[0], c[1]]), l.push(i);
                break;
              case "L":
                o(), l.push([c[0], c[1]]);
                break;
          ...
          return p;
        })(e, 1, i ? 4 - 4 * s.simplification : (1 + s.roughness) / 2);
      if (r) {
                ...
                (function (e, t) {
                  ...
                  for (let { key: i, data: a } of s)
                    switch (i) {
                      ...
                      case "L":
                        n.push(...D(l[0], l[1], a[0], a[1], t)),
                          (l = [a[0], a[1]]);
                        break;
                      case "C": {
                        let [h, u, c, $, p, _] = a;
                        n.push(...R(h, u, c, $, p, _, l, t)), (l = [p, _]);
                        break;
                      }
                      case "Z":
                        n.push(...D(l[0], l[1], r[0], r[1], t)),
                          (l = [r[0], r[1]]);
                    }
                  return { type: "path", ops: n };
                })(e, s)
  ...
  class J {
          ...
          case "fillPath":
            ...
            let l =
              "curve" === e.shape || "polygon" === e.shape
                ? "evenodd"
                : "nonzero";
            this._drawToContext(n, r, l), n.restore();
            break;
          case "fillSketch":
    ...
    line(e, t, s, n, r) {
      let l = this.gen.line(e, t, s, n, r);
      return this.draw(l), l;
    }
    rectangle(e, t, s, n, r) {
      let l = this.gen.rectangle(e, t, s, n, r);
      return this.draw(l), l;
    }
    ellipse(e, t, s, n, r) {
      let l = this.gen.ellipse(e, t, s, n, r);
      return this.draw(l), l;
    }
    circle(e, t, s, n) {
    ...
    arc(e, t, s, n, r, l, i = !1, a) {
      let o = this.gen.arc(e, t, s, n, r, l, i, a);
  ...
  class U {
    ...
    draw(e) {
      ...
      for (let l of t) {
        ...
        switch (l.type) {
          case "path":
            (i = n.createElementNS(K, "path")).setAttribute(
              "d",
              this.opsToPath(l)
            ),
              i.setAttribute("stroke", s.stroke),
              i.setAttribute("stroke-width", s.strokeWidth + ""),
          ...
          case "fillPath":
            (i = n.createElementNS(K, "path")).setAttribute(
              ...
              i.setAttribute("fill", s.fill || ""),
              ("curve" !== e.shape && "polygon" !== e.shape) ||
                i.setAttribute("fill-rule", "evenodd");
            break;
          case "fillSketch":
            i = this.fillSketch(n, l, s);
        }
        i && r.appendChild(i);
      }
      return r;
...
function displayWord() {
  (wordContainer.innerHTML = `
    ...
    selectedWord.title
      .toLocaleLowerCase()
      .split("")
      .every((e) => correctLetters.includes(e)) &&
...
window.addEventListener("keydown", (e) => {
  ...
  e.key >= "a" &&
    e.key <= "z" &&
    (selectedWord.title.toLocaleLowerCase().includes(t)
