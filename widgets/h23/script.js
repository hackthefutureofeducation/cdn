...
const wordContainer = document.getElementById("word-container"),
  ...
  words = [
    {
        "title": "consumer_consciousness",
        "hint": "Target's awareness or perception of something."
    },
    {
        "title": "psychological_processes",
        "hint": "Stuff that happens in your head."
    },
    {
        "title": "consumer_characteristics",
        "hint": "How a person is, thinks, and acts."
    },
    {
        "title": "decision_processes",
        "hint": "How a person makes up his mind."
    },
    {
        "title": "purchase_decisions",
        "hint": "Choosing to buy something."
    },
    {
        "title": "marketing_stimuli",
        "hint": "How the 4Ps affect us."
    },
    {
        "title": "motivation",
        "hint": "The why!"
    ...
    {
        "title": "perception",
        "hint": "How you see things."
    },
    {
        "title": "learning",
        "hint": "The third psychological process."
    },
    {
        "title": "memory",
        "hint": "The fourth psychological process."
    }
];
    ...
    (wordContainer.innerHTML = `
      ${selectedWord.title
        ...
        .map(
          (e) => `
          <span class="letter" ${
            correctLetters.includes(e.toLocaleLowerCase()) && "_" == e && "id='blank'"
          }>${correctLetters.includes(e.toLocaleLowerCase()) ? e : ""}</span>
        `
        )
        .join("")}
    `);
  ...
  e.key >= "a" &&
    ...
    (selectedWord.title.includes(t)
      ? correctLetters.includes(t)
        ? showNotification()
        : (correctLetters.push(t.toLocaleLowerCase()), displayWord())
