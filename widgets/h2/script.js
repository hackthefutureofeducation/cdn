...
const wordContainer = document.getElementById("word-container"),
  ...
  words =[
    ...
    {
        "title": "Question_Marks",
        "hint": "Can turn out to be (un)profitable."
    },
    {
        "title": "Dogs",
        "hint": "Not very profitable."
    },
    {
        "title": "Market_penetration",
        "hint": "Same products - Same Markets"
    },
    {
        "title": "Market_development",
        "hint": "New Markets - Same Products"
    },
    {
        "title": "Product_development",
        "hint": "Modified or new products - Same Markets"
    },
    {
        "title": "Diversification",
        "hint": "New products - New markets"
    }
]
;
...
function displayWord() {
  (document.getElementById("hint").innerHTML = selectedWord.hint),
    (wordContainer.innerHTML = `
      ${selectedWord.title.toLocaleLowerCase()
        .split("")
        .map(
          (e) => `
          <span class="letter" ${
        ...
        .join("")}
    `);
  selectedWord.title.toLocaleLowerCase().split("").every((e) => correctLetters.includes(e)) &&
...
function updateWrongLetters() {
  (wrongLettersContainer.innerHTML = wrongLetters.join(", ")),
    10 === wrongLetters.length &&
      ...
      (finalMessage.innerHTML = `Game Over! <br> Answer: <br> ${selectedWord.title.toLocaleLowerCase().replace(
        "_",
        " "
      )}`),
      messageContainer.classList.remove("hidden")),
...
selectedWord.title.toLocaleLowerCase().includes("_") && correctLetters.push("_");
